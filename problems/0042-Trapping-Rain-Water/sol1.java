...
// Language   : Java
// Solution   : #1
// Runtime    : 433 ms (Beats 4%)
// Memory     : 47.6 MB (Beats 67%)
...
class Solution {
    public int trap(int[] height) {
        ...
        while (high1 < n - 1) {
            ...
            // find the next index whose height is >= height[high1]
            ...
            // no such index (rest of array only descends) -> use the tallest
            // remaining bar as the right boundary
            if (high2 == -1) {
                int maxIdx = high1 + 1;
