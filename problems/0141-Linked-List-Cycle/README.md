...
<picture>
  ...
  <img alt="Topics: Hash Table, Linked List, Two Pointers, Floyd's Cycle Finding Algorithm — best runtime 0 ms (Beats 100%), best memory 47 MB (Beats 16%)" src="panel-dark.svg">
</picture>
